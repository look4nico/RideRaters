...
function login(e) {
    ...
    $(document).ready(function(){
        $.ajax({
            url: 'http://localhost/rideratersback/login2.php',
            dataType: 'json',
            async: 'false',
            type: 'post',
...
function signup(e) {
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: 'http://localhost/rideratersback/signup2.php',
            dataType: 'json',
            async: 'false',
            type: 'post',
            data: {username: vEmail, password: vPassword},
...
function resetPassword(e) {
    ...
    $(document).ready(function(){
        e.preventDefault();
        return $.ajax({
            url: 'http://localhost/rideratersback/resetpass.php',
            dataType: 'json',
            async: 'false',
            type: 'post',
...
fetch('/rideraters/data/data.json')
...
function search(data) {
    ...
    if (searchParks) {
        searchParks.addEventListener('input', () => {
            ...
            const filteredParks = data.filter(park => {
                if (searchFilters != undefined && searchFilters.parkCity) {
                    // only return parks that match the city filter
                    console.log(park.park);
                    if (park.location === searchFilters.parkCity) {
                        console.log(park.location)
